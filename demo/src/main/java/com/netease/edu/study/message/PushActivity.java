...
public class PushActivity extends BaseAgentActivity implements PushMessageRevicer.IPushCallback,
    ...
    protected void onDestroy() {
        super.onDestroy();
        PushMessageRevicer.unRegisterPushCallback(this);
    }
    ...
    private void registerBroadcast() {
        PushMessageRevicer.registerPushCallback(this);
    }
    ...
    public void onReceive(Intent intent) {
        if (intent != null) {
            ...
            if (b != null && PushMessageRevicer.ACTION_TOKEN.equals(action)) {
                token = b.getString(PushMessageRevicer.ACTION_TOKEN);
                showLog(token);
            } else if (b != null && PushMessageRevicer.ACTION_UPDATEUI.equals(action)) {
